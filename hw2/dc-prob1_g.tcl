...
analyze -format verilog prob1_g.v
...
#===== Reports
write -format verilog -output prob1_g.vg -hierarchy $NameDesign

report_area               > prob1_g.area
report_cell               > prob1_g.cell
report_hierarchy          > prob1_g.hier
report_net                > prob1_g.net
report_power              > prob1_g.pow
report_timing -nworst 10  > prob1_g.tim
