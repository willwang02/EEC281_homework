...
#===== Reports
write -format verilog -output prob1_c.vg -hierarchy $NameDesign

report_area               > prob1_c.area
report_cell               > prob1_c.cell
report_hierarchy          > prob1_c.hier
report_net                > prob1_c.net
report_power              > prob1_c.pow
report_timing -nworst 10  > prob1_c.tim
