...
analyze -format verilog prob1_d.v
...
#===== Reports
write -format verilog -output prob1_d.vg -hierarchy $NameDesign

report_area               > prob1_d.area
report_cell               > prob1_d.cell
report_hierarchy          > prob1_d.hier
report_net                > prob1_d.net
report_power              > prob1_d.pow
report_timing -nworst 10  > prob1_d.tim
