...
analyze -format verilog prob4.v
...
#===== Reports
write -format verilog -output prob4.vg -hierarchy $NameDesign

report_area               > prob4.area
report_cell               > prob4.cell
report_hierarchy          > prob4.hier
report_net                > prob4.net
report_power              > prob4.pow
report_timing -nworst 10  > prob4.tim
