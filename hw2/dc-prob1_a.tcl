...
analyze -format verilog prob1_a.v
...
#===== Reports
write -format verilog -output prob1_a.vg -hierarchy $NameDesign

report_area               > prob1_a.area
report_cell               > prob1_a.cell
report_hierarchy          > prob1_a.hier
report_net                > prob1_a.net
report_power              > prob1_a.pow
report_timing -nworst 10  > prob1_a.tim
