...
analyze -format verilog ./DUMMY_NAME.v
...
#===== Reports
write -format verilog -output DUMMY_NAME.vg -hierarchy $NameDesign

report_area               > DUMMY_NAME.area
report_cell               > DUMMY_NAME.cell
report_hierarchy          > DUMMY_NAME.hier
report_net                > DUMMY_NAME.net
report_power              > DUMMY_NAME.pow
report_timing -nworst 10  > DUMMY_NAME.tim
