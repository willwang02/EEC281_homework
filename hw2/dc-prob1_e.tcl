...
analyze -format verilog prob1_e.v
...
#===== Reports
write -format verilog -output prob1_e.vg -hierarchy $NameDesign

report_area               > prob1_e.area
report_cell               > prob1_e.cell
report_hierarchy          > prob1_e.hier
report_net                > prob1_e.net
report_power              > prob1_e.pow
report_timing -nworst 10  > prob1_e.tim
