...
analyze -format verilog prob1.v
...
#===== Reports
write -format verilog -output prob1.vg -hierarchy $NameDesign

report_area               > prob1.area
report_cell               > prob1.cell
report_hierarchy          > prob1.hier
report_net                > prob1.net
report_power              > prob1.pow
report_timing -nworst 10  > prob1.tim
