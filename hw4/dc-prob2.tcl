...
analyze -format verilog prob2.v
...
#===== Reports
write -format verilog -output prob2.vg -hierarchy $NameDesign

report_area               > prob2.area
report_cell               > prob2.cell
report_hierarchy          > prob2.hier
report_net                > prob2.net
report_power              > prob2.pow
report_timing -nworst 10  > prob2.tim
